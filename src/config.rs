...
pub const HOST_IP: &'static str = env!("HOST_IP");
...
";
pub const NOT_FOUND_MESSAGE: &str = "Media is not found";
pub const NOT_SUPPORTED_TYPE: &str = "This media type is currently not supported";